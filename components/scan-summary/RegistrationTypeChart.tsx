...
export default function RegistrationTypeChart({ rows }: Props) {
    ...
    <Card className="p-0 overflow-hidden border-sky-200 shadow-lg shadow-sky-100">
      ...
      <div className="border-b border-sky-100 bg-gradient-to-r from-sky-50 to-white p-5">
        ...
        <p className="mt-1 text-sm text-slate-500">
          Visitor distribution by registration type
        </p>
      </div>
      ...
      <div className="p-4">
        <div className="relative h-[340px]">
          ...
          <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
            ...
            <span className="text-sm text-slate-500">Registrations</span>
          </div>
        </div>
